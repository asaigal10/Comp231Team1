export default function NavBar({currentDayOfWeek}) {
    return <div id="Navbar" className="flex flex-row justify-center w-screen max-w-6xl m-auto my-4">
        <p className="mx-10 text-white hover:text-orange-500 flex-1 justify-items-start">Home</p>
        ...
        <p className="mx-10 text-white hover:text-orange-500 flex-1 justify-self-end text-right">Settings</p>
    </div>
}